 ...
 *
 * @ViewsAccess(
 *   id = "current_user_in_route_or_permission",
 *   title = @Translation("Current user in route or permission"),
 *   help = @Translation("Access will be granted to user with the same id as %user from path parametr or with a permission 'view users user ownership'.")
 * )
 */
class CurrentUserInRouteOrPermission extends AccessPluginBase implements CacheableDependencyInterface {
